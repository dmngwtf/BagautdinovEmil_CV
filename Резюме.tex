...
\end{itemize}
	...
	\section*{Цель}
	Хочу начать карьеру в IT-компании, где смогу применить накопленные знания в продуктовой разработке. Интересуюсь созданием качественных и полезных решений, стремлюсь развиваться в команде профессионалов. Готов быстро обучаться, брать ответственность и приносить практическую пользу с первых задач.
